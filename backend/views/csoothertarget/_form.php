...
<div class="cso-other-target-form">
  ...
  <?= $form->field($model,'target_to')->widget(DatePicker::className(),['clientOptions' => ['defaultDate' => 'php:Y-m-d'],'options' => ['class' => 'form-control'], 'dateFormat' => 'php:Y-m-d']) ?>
    ...
    <?= $form->field($model, 'sales_conversion_target')->textInput() ?>

    <?= $form->field($model, 'sales_amount_target')->textInput() ?>

    <?= $form->field($model, 'call_target')->textInput() ?>
