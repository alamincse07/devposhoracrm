...
<br>
      ...
      <div class="col-md-12">	  
       ...
       <input type="submit" class="btn btn-primary" value="SSO’s Activities Status" name="ssoactivitiesstatus">&nbsp;&nbsp;&nbsp;
        <input type="submit" class="btn btn-info" value="SSO’s Activities Download" name="ssodownload">&nbsp;&nbsp;&nbsp;
