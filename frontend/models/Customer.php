...
class Customer extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['customer_name', 'contact_number', 'added_date', 'added_by'], 'required'],
            [['gender', 'app_install'], 'string'],
            [['added_date', 'edit_date'], 'safe'],
            [['customer_name', 'contact_number', 'company_name', 'call_number_source', 'customers_type', 'customers_categories', 'city', 'zone', 'location', 'address', 'customer_level', 'added_by', 'edit_by'], 'string', 'max' => 255],
        ];
    }
